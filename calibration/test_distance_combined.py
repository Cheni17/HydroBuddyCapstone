...
# Import sensor functions from the main sensors module
# This ensures test script uses SAME interface as main.py
...
def classify_ultrasonic(distance_cm):
    """Classify ultrasonic reading for display purposes."""
    if distance_cm is None:
        return "⚠️ BAD READING"
    if distance_cm < ULTRASONIC_WATER_THRESHOLD:
        return "🌊 water/object within 10cm"
